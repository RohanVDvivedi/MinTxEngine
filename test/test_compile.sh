...
gcc -Wall -O3 -flto ./test_mindb.c -o test_mindb.out -I. -lmintxengine -ltupleindexer -ltuplestore -lwale -lz -lbufferpool -lblockio -lboompar -llockking -lcutlery -lpthread
