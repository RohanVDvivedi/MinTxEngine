...
PUBLIC_HEADERS:=mini_transaction_engine.h mini_transaction_engine_stats.h log_record.h system_page_header_util.h mini_transaction_engine_wale_only_functions.h mini_transaction_engine_bufferpool_only_functions.h mini_transaction_engine_page_alloc.h mini_transaction_engine_page_allotment.h
...
LFLAGS:=-L${LIB_DIR} -l${PROJECT_NAME} -ltuplestore -lwale -lbufferpool -lrwlock -lserint -lcutlery -lpthread
# Archiver
AR:=ar rcs
