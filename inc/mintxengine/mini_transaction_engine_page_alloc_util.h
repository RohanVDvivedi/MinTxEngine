...
void* allocate_page_from_hints_without_database_expansion_INTERNAL(mini_transaction_engine* mte, mini_transaction* mt, uint64_t* page_id); // checks all pages from a few of the page_allocation_hints module, and use the one that is found
void* allocate_page_without_database_expansion_INTERNAL(mini_transaction_engine* mte, mini_transaction* mt, uint64_t* page_id); // checks all pages until one is found and allocated
